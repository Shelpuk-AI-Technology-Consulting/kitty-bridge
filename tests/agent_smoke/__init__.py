...
network beyond loopback. Three test classes ship with the package
(five test functions in total):
...
(the safety-critical branch that reaps a hung child). The
settings-precedence claim (T-I6) and the live nightly scenarios
(T-K11, T-I14) belong elsewhere and inherit the bridge fixture from
:mod:`harness.bridge` rather than this package.
