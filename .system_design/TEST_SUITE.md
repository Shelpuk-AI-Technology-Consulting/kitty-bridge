...
and it needs a recorder and an oracle. Thirteen such omissions are already known and filed: G22
(headers), G26 (P13's CC-origin twin), G27 (an allowlisted field dropped for being falsy), G28
...
dropped on the translated route). **None of the thirteen was found by a guard** — the earlier ones
