...
and it needs a recorder and an oracle. Thirteen such omissions are already known and filed:
G23 (`openai_subscription`'s `reasoning` injection), G26 (P13's CC-origin twin),
