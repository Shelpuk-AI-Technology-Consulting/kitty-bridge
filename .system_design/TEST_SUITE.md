...
| All backends unhealthy | The 503 arrives in each protocol's native error envelope — but only once no recovery fits inside KBR-243's 300 s arrival-recovery window (`SYSTEM_DESIGN.md` §4.2); inside it the request is held and served |
