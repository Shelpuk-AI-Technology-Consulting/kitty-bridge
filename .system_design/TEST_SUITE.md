...
and it needs a recorder and an oracle. Nine such omissions are already known and filed: G26
...
KBR-271). **None of the thirteen was found by a guard** (six now remain open — G26, G27, G32, G37, G38, G43 — the other seven closed by KBR-184 and KBR-55) — the earlier ones by walking the
